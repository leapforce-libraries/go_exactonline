...
func (eo *ExactOnline) GetItemAssortmentsInternal(filter string) (*[]ItemAssortment, *errortools.Error) {
...
func (eo *ExactOnline) GetItemAssortments() (*[]ItemAssortment, *errortools.Error) {
