...
func (eo *ExactOnline) GetActiveEmploymentsInternal(filter string) (*[]ActiveEmployment, *errortools.Error) {
...
func (eo *ExactOnline) GetActiveEmployments() (*[]ActiveEmployment, *errortools.Error) {
