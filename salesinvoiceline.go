...
func (eo *ExactOnline) GetSalesInvoiceLinesInternal(filter string) (*[]SalesInvoiceLine, *errortools.Error) {
...
func (eo *ExactOnline) GetSalesInvoiceLines() (*[]SalesInvoiceLine, *errortools.Error) {
